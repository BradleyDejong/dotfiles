...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(pollen-mode company-pollen vue-mode)
...
values."
  ...
  (setq-default
   ...
   ;; If 
non nil `spacemacs/toggle-fullscreen' will not use native fullscreen.
